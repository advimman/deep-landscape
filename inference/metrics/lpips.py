...
DEFAULT_MODEL_PATH = os.path.join(os.path.dirname(__file__), 'lpips_models', 'vgg.pth')


class LPIPSLossWrapper(nn.Module):
    @staticmethod
    def get_args(parser):
    ...
    def __init__(self, model_path=DEFAULT_MODEL_PATH):
        super(LPIPSLossWrapper, self).__init__()
        self.calc_grad = False # args.lps_calc_grad
        ...
        self.loss = PerceptualLoss(
            model='net-lin', net='vgg', model_path=model_path,
            use_gpu=True, gpu_ids=[0]).eval()
